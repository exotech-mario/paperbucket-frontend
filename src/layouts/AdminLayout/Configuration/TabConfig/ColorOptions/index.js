    ...
    colorOptions = (
      <div>
        ...
        <div className="theme-color laybg-color small">
          <Link
            to="#"
            onClick={() => onChangeLayout6Background('linear-gradient(to right, #1AB394 0%, #1AB394 100%)')}
            className={layout6Background === 'linear-gradient(to right, #1AB394 0%, #1AB394 100%)' ? 'active' : ''}
            data-value="linear-gradient(to right, #1AB394 0%, #1AB394 100%)"
            style={{ background: 'linear-gradient(to right, #1AB394 0%, #1AB394 100%)' }}
          >
            <span />
          </Link>
          <Link
